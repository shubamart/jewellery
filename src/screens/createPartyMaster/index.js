...
const CreatePartyMaster = (props) => {
        ...
        const loadUserData = async () => {
            try {
                ...
                if (jsonValue) {
                    ...
                    setInitialUsername(user?.wusername || '');
                }
            } catch (error) {
    ...
    const submitFormData = async (formData, resetForm) => {
        ...
        try {
            const response = await fetch(`${BASE_URL}add-party.php`, {
              method: 'POST',
              headers: {
                ...
                >
                    <View style={styles.container}>
                        ...
                        <View style={styles.header}>
                            ...
                            <View>
                                <Text style={styles.headerTitle}>Add Party Master</Text>
                            </View>
                            <View style={{ width: 24 }} />
                        </View>
