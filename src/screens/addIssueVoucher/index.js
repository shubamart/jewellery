...
const AddIssueVoucher = (props) => {
  ...
  // Show in UI
    ...
    const submitFormData = async (formData, resetForm) => {
        ...
        try {
            const response = await fetch(`${BASE_URL}add_issue_voucher.php`, {
                ...
                >
                    <View style={styles.container}>
                        ...
                        <View style={styles.header}>
                            ...
                            <View>
                                <Text style={styles.headerTitle}>Add Jewellery Issue Voucher</Text>
                            </View>
                            <View style={{ width: 24 }} /> 
                        </View>
                        ...
                        <View style={[Layout.column.flexDirection, MARGIN_T_SMALL]}>
                            ...
                            <CustomInputComp
                                placeholder="G Wt."
                                value={values.issuegrosswt}
                                onChangeText={(t) => {
                                    setFieldValue('issuegrosswt', t);
                                    const g = parseFloat(t) || 0;
                                    const d = parseFloat(values.issuedwt) || 0;
                                    const s = parseFloat(values.issuestwt) || 0;
                                    setFieldValue('issuetotalwt', (g + d + s).toFixed(3));
                                    setFieldValue('wusername', user?.wusername);
                                }}
                                // onChangeText={(t) => setFieldValue('issuegrosswt', t)}
                                onBlur={handleBlur('issuegrosswt')}
                                formatOnBlur
                                keyboardType="numeric"
                            />

                            {touched.issuegrosswt && errors.issuegrosswt && (
                                <Text style={styles.errorText}>{errors.issuegrosswt}</Text>
                            )}
                            ...
                            <CustomInputComp
                                placeholder="D Wt."
                                value={values.issuedwt}
                                onChangeText={(t) => {
                                    setFieldValue('issuedwt', t);
                                    const g = parseFloat(values.issuegrosswt) || 0;
                                    const d = parseFloat(t) || 0;
                                    const s = parseFloat(values.issuestwt) || 0;
                                    setFieldValue('issuetotalwt', (g + d + s).toFixed(3));
                                }}
                                // onChangeText={(t) => setFieldValue('issuedwt', t)}
                                onBlur={handleBlur('issuedwt')}
                                formatOnBlur
                                keyboardType="numeric"
                            />

                            {touched.issuedwt && errors.issuedwt && (
                                <Text style={styles.errorText}>{errors.issuedwt}</Text>
                            )}
                            ...
                            <CustomInputComp
                                placeholder="St. Wt."
                                value={values.issuestwt}
                                onChangeText={(t) => {
                                    setFieldValue('issuestwt', t);
                                    const g = parseFloat(values.issuegrosswt) || 0;
                                    const d = parseFloat(values.issuedwt) || 0;
                                    const s = parseFloat(t) || 0;
                                    setFieldValue('issuetotalwt', (g + d + s).toFixed(3));
                                }}
                                // onChangeText={(t) => setFieldValue('issuestwt', t)}
                                onBlur={handleBlur('issuestwt')}
                                formatOnBlur
                                keyboardType="numeric"
                            />

                            {touched.issuestwt && errors.issuestwt && (
                                <Text style={styles.errorText}>{errors.issuestwt}</Text>
                            )}
                            ...
                            <CustomInputComp
                                placeholder="Total"
                                value={values.issuetotalwt}
                                keyboardType="numeric"
                                editable={false} 
                            />

                            {touched.issuetotalwt && errors.issuetotalwt && (
                                <Text style={styles.errorText}>{errors.issuetotalwt}</Text>
                            )}
                            ...
                            <InputComp
                                ...
                                onChangeText={(t) => {
                                    ...
                                    const total = parseFloat(values.issuegrosswt || 0) +
                                                parseFloat(values.issuedwt || 0) +
                                                parseFloat(values.issuestwt || 0);

                                    const rate = parseFloat(t) || 0;
                                    setFieldValue('issuewastage', ((total * rate) / 100).toFixed(3));
                                }}
                                onBlur={() => {
                            ...
                            <CustomInputComp
                                placeholder="Gms."
                                value={values.issuewastage}
                                // onChangeText={(t) => setFieldValue('issuewastage', t)}
                                // onBlur={handleBlur('issuewastage')}
                                // formatOnBlur
                                editable={false}
                                keyboardType="numeric"
                            />

                            {touched.issuewastage && errors.issuewastage && (
                                <View>
                                    <Text style={styles.errorText}>{errors.issuewastage}</Text>
                                </View>
                            )}
...
export default AddIssueVoucher
