...
try {
    ...
    $vdate = $data['vdate'] ?? '';
    $pname = $data['pname'] ?? '';
       $recgrosswt  = isset($data['recgrosswt'])  && $data['recgrosswt']  !== '' ? floatval($data['recgrosswt'])  : 0;
    $recdwt      = isset($data['recdwt'])      && $data['recdwt']      !== '' ? floatval($data['recdwt'])      : 0;
    $recstwt     = isset($data['recstwt'])     && $data['recstwt']     !== '' ? floatval($data['recstwt'])     : 0;
    $rectotalwt  = isset($data['rectotalwt'])  && $data['rectotalwt']  !== '' ? floatval($data['rectotalwt'])  : 0;
    $status = $data['status'] ?? '';
    $wpurity = $data['wpurity'] ?? '';
    $recwastage  = isset($data['recwastage'])  && $data['recwastage']  !== '' ? floatval($data['recwastage'])  : 0;
    ...
    if ($stmt->execute()) {
        ...
        $vdate, $acode, $status, $vno, $flag, $recwastage, $rectotalwt, $wusername, $pname
        );
